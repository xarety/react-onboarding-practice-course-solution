...
export const Post: React.FC<PostProps> = observer(({ post, onEdit, onDelete }) => {
    ...
    return (
        <Card>
            <Card.Section>
                <p className="h3 m-0 m-b-1">{title}</p>

                <p className="fs-2 m-0">{description}</p>
            </Card.Section>
                    ...
                    >
                        <Dropdown.Menu>
                            ...
                            <Confirm confirmation={DeleteConfirmation} onConfirm={handleDelete}>
                                {onClick => <Dropdown.Item onClick={onClick}>Delete</Dropdown.Item>}
                            </Confirm>
                        </Dropdown.Menu>
                    </Dropdown>
                </Stack>
